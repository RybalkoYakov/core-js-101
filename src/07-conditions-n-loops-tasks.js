...
function doRectanglesOverlap(rect1, rect2) {
  if (rect1.top + rect1.height < rect2.top || rect2.top + rect1.height < rect1.top) return false;
  if (rect1.left + rect1.width < rect2.left || rect2.left + rect1.width < rect1.left) return false;
  return true;
}
...
function getDigitalRoot(num) {
  ...
  const sum = num.toString().split('').map((value) => parseInt(value, 10)).reduce((acc, currentValue) => acc + currentValue, 0);
