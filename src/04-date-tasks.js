...
function timeSpanToString(startDate, endDate) {
  ...
  function numberToString(number, stringLength) {
    ...
    return stringNumber.length < stringLength ? new Array(stringLength - stringNumber.length).fill('0').join('') + stringNumber : stringNumber;
  }

  return `${numberToString(HH, 2)}:${numberToString(mm, 2)}:${numberToString(ss, 2)}.${numberToString(sss, 3)}`;
}
